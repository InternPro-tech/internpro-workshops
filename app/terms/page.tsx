...
const TermsPage = () => {
  return (
    <div style={{ padding: "2rem", fontFamily: "Arial, sans-serif" }}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to InternPro, Qtr no. 10/24, Medical Square.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to InternPro, accessible from{" "}
            <a
              href="https://internpro.tech"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://internpro.tech
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: contactus@internpro.tech</p>
        </li>
        <li>
          <p>By phone number: 7378906594</p>
        </li>
      </ul>
    </div>
  );
